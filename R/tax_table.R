...
#' @param length (integer) The length of the prefix.
#'
#' @return data.frame
#' @export
#'
#' @examples \dontrun{tax_dePrefix <- tax_trim_prefix(tax = tax, index = c(2:8), length = 3)}
#'
tax_trim_prefix <- function(tax, index, length)
{
  table2 <- tax
