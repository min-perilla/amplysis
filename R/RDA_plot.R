...
#' @examples
#' \dontrun{
#' rda1 <- RDA(otu, env, metadata, 1, "group")
#' RDA_plot(data = rda1, group = "group", custom_order = NULL,
...
#'
RDA_plot = function(data, color_scheme = NULL, group = "group", custom_order = NULL, seed = 123,
         ...
         filename = "RDA", file_width = 16, file_height = 9)
{
  ...
  p1 <- ggplot2::ggplot(
    ...
    ggrepel::geom_text_repel(
      ...
      alpha = 0.8, show.legend = F, seed = seed) +
