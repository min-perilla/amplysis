...
data_sta_p1 = stackbar(otu = otu, tax = tax, metadata = metadata, 
                      id_col = 1, tax_cla = "phylum", group1 = "group2", group2 = "group3", replicate_method = "none", row_n = 8)
...
data_sta_g1 = stackbar(otu = otu, tax = tax, metadata = metadata, 
                      id_col = 1, tax_cla = "genus", group1 = "group2", group2 = "group3", replicate_method = "none", row_n = 20)
...
data_sta_p2 = stackbar(otu = otu, tax = tax, metadata = metadata, 
                      id_col = 1, tax_cla = "phylum", group1 = "group2", group2 = "group", replicate_method = "none", row_n = 8)
...
data_sta_g2 = stackbar(otu = otu, tax = tax, metadata = metadata, 
                       id_col = 1, tax_cla = "genus", group1 = "group2", group2 = "group", replicate_method = "none", row_n = 20)
